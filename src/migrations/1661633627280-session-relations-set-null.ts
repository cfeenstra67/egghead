...
export class sessionRelationsSetNull1661633627280 implements MigrationInterface {
    name = 'sessionRelationsSetNull1661633627280'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_session"("id", "tabId", "url", "title", "rawUrl", "parentSessionId", "transitionType", "startedAt", "endedAt", "nextSessionId", "host", "dum", "interactionCount", "lastInteractionAt", "chromeVisitId", "chromeReferringVisitId") SELECT "id", "tabId", "url", "title", "rawUrl", "parentSessionId", "transitionType", "startedAt", "endedAt", "nextSessionId", "host", "dum", "interactionCount", "lastInteractionAt", "chromeVisitId", "chromeReferringVisitId" FROM "session"`);
