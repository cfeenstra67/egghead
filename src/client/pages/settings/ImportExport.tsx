  ...
  return (
    <Layout>
      <div className="flex flex-1 overflow-hidden">
        <SettingsSideBar page={SettingsPage.ImportExport} />
        ...
        <main className="flex-1 overflow-hidden p-4 max-w-[700px] mx-auto">
          ...
          <div className="rounded-xl border shadow p-6 grid grid-cols-[1fr_auto] items-center gap-4 gap-y-6">
            ...
            <div className="flex flex-col gap-6 col-span-2">
              ...
              <div className="text-sm text-muted-foreground">
                Import a database that you've exported using the feature above
                in the past.{" "}
                <strong>This will replace your existing database.</strong>
              </div>
              <div>
                <Input
                  type="file"
